...
if __name__ == "__main__":
    ...
    # 提取码：ruzz
    root_dir_train = r"D:\Users\bob\project\ai\covid-19-demo\covid-19-dataset-2\train"  # path to your data
    root_dir_valid = r"D:\Users\bob\project\ai\covid-19-demo\covid-19-dataset-2\valid"  # path to your data
    train_set = COVID19Dataset_2(root_dir_train)
    valid_set = COVID19Dataset_2(root_dir_valid)

    # =========================== COVID19Dataset_3 ===================================
    root_dir = r"D:\Users\bob\project\ai\covid-19-demo\covid-19-dataset-3\imgs"  # path to your data
    path_csv = r"D:\Users\bob\project\ai\covid-19-demo\covid-19-dataset-3\dataset-meta-data.csv"  # path to your data
